...
SVG_ICON_MAP = {
    ...
    "amazon": r"""<svg class="buttn-svg-icon" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64"><path d="M39.5 39.2c-3.3 2.8-8 4.3-12.1 4.3-6.8 0-12.9-2.5-17.5-6.7-1-.9-.1-2 1.1-1.3 5 2.9 10.6 4.4 16.6 4.4 3.7 0 7.8-.8 11.6-2.4 1.8-.8 2.1.7.3 1.7zM42 21.7c0-3.5-3-5.6-7.2-5.6-4.5 0-8.1 2.1-9.1 6.5l-7.7-.7C19.1 14.7 25.4 10 35.3 10c9.2 0 14.6 4.3 14.6 12.2v16.1c0 2.4.9 3.4 1.8 4.7.3.5.4 1.1-.1 1.5l-6 5c-.5.4-1.1.4-1.5 0-2.1-1.8-2.5-2.7-3.7-4.5-3.5 3.6-6 4.7-10.6 4.7-5.4 0-9.6-3.3-9.6-10 0-5.2 2.8-8.8 6.9-10.5 3.5-1.6 8.4-1.9 12.1-2.3l2.8-.3v-1.9zm0 10c-4.7.4-13 1-13 7.1 0 3.1 1.9 4.6 4.4 4.6 2.8 0 5.4-1.8 6.9-4.7 1.3-2.4 1.7-4.7 1.7-7zM54.2 45.5c-1.8 4.6-5.7 8.4-10.2 10.5-1.1.5-1.9-.5-.9-1.2 3.2-2.3 6-5.7 7.3-9.2.4-1.1-.1-1.5-1.1-1.5-1.7 0-4.5.5-6.3.7-.9.1-1.1-.7-.2-1.3 3.1-2.1 8.1-1.5 9.8-.8 1.7.7 2.3 1.2 1.6 2.8z"/></svg>""",
    ...
    "paypal": r"""<svg class="buttn-svg-icon" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64"><path d="M16 54l9-44h19c9 0 14 4.8 12.7 12.2C55.2 31 48.9 36 39.7 36h-8.6l-3.7 18H16zm17-27h7.6c4.5 0 7.2-2.2 7.9-5.8.6-3.4-1.5-5.2-5.8-5.2h-8L33 27zM10 58l8-39h9l-1.6 8h-3.2L16 58h-6z"/></svg>""",
    "venmo": r"""<svg class="buttn-svg-icon" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64"><path d="M12 10h10l6.1 31.3C34.5 31 39 21.4 39 14.4c0-1.5-.2-2.9-.6-4.4h10.2c.4 1.6.6 3.1.6 4.8 0 11.4-9.7 28.3-18.1 39.2H20.5L12 10z"/></svg>""",
